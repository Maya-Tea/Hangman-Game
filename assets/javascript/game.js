    ...
    words=["PARABOLA", "SINE|WAVE", "DERIVATIVE", "DOUBLE|INTEGRAL", "CENTRAL|LIMIT|THEOREM", "TANGENT|LINE", "SUBTRACTION", "FRACTION", "CUBED", "POWER","DIVISOR","MULTIPLIER","TRIANGLE","RHOMBUS","TRAPAZOID", "COORDINATE","VECTOR", "CONCENTRIC|CIRCLES", "FRACTION","DECIMAL", "LAPLACE|TRANSFORM","PARALLELOGRAM","PERPENDICULAR","PROOF","INTEGER","NEGATIVE|NUMBER","RIGHT|ANGEL","DIVIDE","SERIES","PERMUTATION","COMBINATION","ADD","CALCULUS","PROBABILITY","LINEAR|ALGEBRA","TRIGONOMETRY","GEOMETRY"];
